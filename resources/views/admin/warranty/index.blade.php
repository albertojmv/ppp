        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{URL::to("admin/warrantydetail/$warranty->id/edit")}}" class="btn btn-success"><img src="/images/editar.png"></a>
                    </td>
                    <td>
                        {!!Form::open(['route'=>['admin.warrantydetail.destroy',$warranty->id ], 'method'=>'DELETE'])!!}
