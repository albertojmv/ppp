    ...
    <body data-spy="scroll" data-target="#navbar" data-offset="0">
        ...
        <footer id="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        &copy; {{Carbon\Carbon::now()->year}} <a target="_blank" href="http://jodamapi.com/" title="Jodamapi todos los derechos reservados.">Jodamapi</a>. Todos los derechos reservados.
                    </div>
                    <div class="col-sm-6">
