...
<script>
    function validate() {
        var result = confirm("¿Estás seguro que quieres editar este pago?");
        return result;
    }
</script>
...
<div class="panel panel-yellow">
    ...
    <div class="panel-body pan">
        ...
        {!!Form::model($pago,['route'=>['collector.payments.update',$pago],'method'=>'PUT'])!!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        ...
                        {!!Form::text('amount',null,['class'=>'form-control','placeholder'=>'Monto'])!!}
                    </div>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-sm-9 controls">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                       ...
                       {!!Form::text('notes',null,['class'=>'form-control','placeholder'=>'Notas'])!!}
                    </div>
                </div>
            </div>

            <input name="quota_id" type="hidden" value="{{$cuota->id}}" />
            <input name="total" type="hidden" value="{{($cuota->amount + $cuota->surcharge)-($pagos->total_amount - $pago->amount)}}" />
        </div></div>
