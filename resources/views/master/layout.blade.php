        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="{{URL::to('admin/payments')}}"><i class="fa fa-desktop fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i><span class="menu-title">Pagos</span></a>
                       
                    </li>
                    <li><a href="{{URL::to('admin/loans')}}"><i class="fa fa-send-o fa-fw">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Préstamos</span></a>
                       
                    </li>
                    <li><a href="{{URL::to('admin/customers')}}"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-violet"></div>
                    </i><span class="menu-title">Clientes</span></a>
                      
                    </li>
                    <li><a href="{{URL::to('admin/users')}}"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-blue"></div>
                    </i><span class="menu-title">Usuarios</span></a>
                          
                    </li>
                    <li><a href="{{URL::to('admin/settings')}}"><i class="fa fa-database fa-fw">
