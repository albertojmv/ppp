...
class CustomerController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view("manager.customers.index")->with("customers", $customers);
    }
    ...
    public function create() {
        ...
        return view('manager.customers.create', compact('countries_list', 'provinces_list', 'civilstatus_list', 'genders_list'));
    }
    ...
    public function store(CustomerCreateRequest $request) {
        ...
        $customer->save();
        return \Redirect::route('manager.customers.index')->with('message', 'Cliente Guardado Correctamente');
    }
    ...
    public function edit($id) {
        ...
        return view('manager.customers.edit', ['customer' => $customer], ['countries_list' => $countries_list])
    ...
    public function update(CustomerUpdateRequest $request, $id) {
        ...
        return Redirect::to('/manager/customers')->with('message', 'Usuario Actualizado Correctamente');
    }
    ...
    public function showCustomer($id) {
        ...
        return view('manager.customers.show', compact('references','customer','incomes'));
    }
