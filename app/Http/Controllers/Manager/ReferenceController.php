...
class ReferenceController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view("manager.references.index")->with("references", $references);
    }
    ...
    public function create() {
        ...
        return view('manager.references.create', ['provinces_list' => $provinces_list], ['references_list' => $references_list]);
    }
    ...
    public function store(Request $request) {
        ...
        $reference->save();
        return Redirect::to('/manager/references/?search=' . $request['customer_id'])
    ...
    public function edit($id) {
        ...
        return view('manager.references.edit', ['provinces_list' => $provinces_list], ['references_list' => $references_list])
    ...
    public function update(Request $request, $id) {
        ...
        $reference->workphone = $request['workphone'];
        $reference->save();
        return Redirect::to('/manager/references/?search=' . $reference->customer_id)
