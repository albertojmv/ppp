...
class WarrantyController extends Controller {
    ...
    public function create() {
        return view('manager.warranty.create');
    }
    ...
    public function store(Request $request) {
        ...
        $warranty_image->save();
        return Redirect::to('/manager/warranty/'.$request['warranty_detail_id'])->with('message', 'La imagen fue guardada correctamente.');
    }
    ...
    public function destroy($id) {
     ...
     public function warranty($id){
          ...
          return view('manager.loans.warranty', ['id' => $id], ['imagenes' => $imagenes]);
    }
