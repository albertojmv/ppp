...
class ReportController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $cuotas = Quota::where('quotastatu_id', '=', 2)
                ...
                ->orderBy('id', 'desc')
                ->paginate(5);
        return view('manager.reports.reportquotesoverdue', ['cuotas' => $cuotas]);
    }
    ...
    public function quotesoverdue() {
        return view('manager.reports.quotesoverdue');
    }
    public function quotespaid() {
        return view('manager.reports.quotespaid');
    }
    public function loanssold() {
        return view('manager.reports.loanssold');
    }
