...
class CalcController extends Controller {
    ...
    public function index() {
        ...
        return view('manager.calc.create', compact('paymentmethod_list', 'calculationtype_list'));
    }
    ...
    public function store(CalcRequest $request) {
        ...
        return view('manager.calc.show', compact('calculationtype_id','amount','interest','quotas','paymentmethod_id','date'))
                        ->with('array', $array);
    }
