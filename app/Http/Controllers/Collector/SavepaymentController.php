...
class SavepaymentController extends Controller {
    ...
    public function index() {
        return view("collector.payments.show");
    }
...
//            $quota_id = $request['quota_id'];
        ...
        if ($amount > $total) {
            ...
            return Redirect::route('collector.payments.create')
        ...
        return Redirect::route('collector.payments.index')->with('message', 'Pago Guardado Correctamente');
    }
