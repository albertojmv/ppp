...
class CustomerController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view("collector.customers.index")->with("customers", $customers);
    }
    ...
    public function create() {
        ...
        return view('collector.customers.create', compact('countries_list', 'provinces_list', 'civilstatus_list', 'genders_list'));
    }
    ...
    public function store(CustomerCreateRequest $request) {
        ...
        $customer->save();
        return \Redirect::route('collector.customers.index')->with('message', 'Cliente Guardado Correctamente');
    }
    ...
    public function edit($id) {
        ...
        return view('collector.customers.edit', ['customer' => $customer], ['countries_list' => $countries_list])
    ...
    public function update(CustomerUpdateRequest $request, $id) {
        ...
        return Redirect::to('/collector/customers')->with('message', 'Usuario Actualizado Correctamente');
    }
    ...
    public function showCustomer($id) {
        ...
        return view('collector.customers.show', compact('references','customer','incomes'));
    }
