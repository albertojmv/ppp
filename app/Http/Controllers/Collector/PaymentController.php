...
class PaymentController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view("collector.payments.index")->with("payments", $payments);
    }
    ...
    public function create() {
        return view("collector.payments.create");
    }
    ...
    public function printPay($id) {
        ...
        return view('collector.payments.recibo2', ['prestamo' => $prestamo], ['cuota' => $cuota])->with("pago", $pago)->with("cliente", $cliente);
    }
    ...
    public function store(PaymentRequest $request) {
        ...
        return view('collector.payments.show', ['prestamo' => $prestamo], ['cuota' => $cuota])->with("formofpayment_list", $formofpayment_list)->with("pagos", $pagos);
        //  } else {
//            $this->validate($request, [
...
//                        ->where('quota_id', '=', $cuota->id)->first();
//
//        return view('collector.payments.edit', ['prestamo' => $prestamo], ['cuota' => $cuota])
//                        ->with("pago", $pago)
...
//
//        return Redirect::route('collector.payments.index')->with('message', ' El pago se editó correctamente.');
    }
