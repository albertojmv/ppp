...
class TypeswarrantyController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view("admin.typeswarranties.index")
                        ->with("warranties", $warranties);
    }

    public function create() {
        return view('admin.typeswarranties.create');
    }
    ...
    public function store(Request $request) {
        ...
        $warranty->name = $name;
        $warranty->save();
        return Redirect::route('admin.typeswarranties.index')->with('message', 'Tipo de garantía creada correctamente.');
    }
    ...
    public function edit($id) {
        ...
        return view('admin.typeswarranties.edit', ['warranty' => $warranty]);
    }
